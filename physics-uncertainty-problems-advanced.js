...
const basicModeDisclaimer = "Howdy partner, are you looking for the advanced content? If so, <button class=\"prettyButton\" onclick=\"showAdvanced()\"> Click here</button>, otherwise here is a calming photo instead.";

const advancedModeDisclaimer = "Howdy partner, are you looking for calming pictures? If so, <button class=\"prettyButton\" onclick=\"showBasic()\"> Click here</button>, otherwise enjoy the advanced content instead."
